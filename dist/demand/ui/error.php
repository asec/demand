    ...
    <div id="content-wrapper">
      <div class="inner clearfix">
        <section id="main-content">
          <h1>
            <a id="demand" class="anchor" href="#demand" aria-hidden="true"><span class="octicon octicon-link"></span></a> I've got a baad feeling about this :(
          </h1>

          <p>
            Something really bad happened, you could probably say it's erroneous in nature:<br />
            <code><?php print $exception -> getMessage() ?></code>
          </p>
